import "../../css/components/carrinhocompras.css";
import { useCart } from "react-use-cart";
import "../../css/components/css.css";
...
const Carrinho = () => {
  ...
  if (isEmpty)
    return (
      <h5 className="text-center text-decoration-underline fw-bolder py-3">
        {" "}
        Carrinho Vazio{" "}
      </h5>
    );
  return (
    <div className="container-fluid py-5">
      <div className="row justify-content-center">
        <h4 className="text-center py-3 text-decoration-underline fw-bolder">
          Meu Carrinho
        </h4>
        <div className="col-sm-12 col-md-12 col-lg-8 col-xl-8 col-xxl-8 py-4">
          <div className="d-flex justify-content-center py-4">
            <p className="position-relative fw-bolder text-title mx-4">
              Carrinho
          ...
          <div className="d-flex justify-content-between py-5 pb-0">
            <button
              ...
              onClick={(item) => emptyCart(item.id)}
            >
              Remover Todos
            </button>
